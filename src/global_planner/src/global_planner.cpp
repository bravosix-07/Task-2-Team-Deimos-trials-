...
**/
void GlobalPlanner::convertToMapCoordinates(float &x, float &y)
{
...
**/
int GlobalPlanner::getGridSquareIndex(float x, float y)
{
...
**/
void GlobalPlanner::getGridSquareCoordinates(int index, float &x, float &y)
{
...
**/
bool GlobalPlanner::isCoordinateInBounds(float x, float y)
{
  bool valid = true;
...
**/
vector<int> GlobalPlanner::runAStarOnGrid(int startGridSquare, int goalGridSquare)
{
...
**/
vector<int> GlobalPlanner::findPath(int startGridSquare, int goalGridSquare, float g_score[])
{
  value++;
  vector<int> bestPath;
...
**/
vector<int> GlobalPlanner::constructPath(int startGridSquare, int goalGridSquare, float g_score[])
{
  vector<int> bestPath;
  vector<int> path;
...
**/
void GlobalPlanner::addNeighborGridSquareToOpenList(multiset<GridSquare> &openSquaresList, int neighborGridSquare, int goalGridSquare, float g_score[])
{
  GridSquare gridSq;
...
vector<int> GlobalPlanner::findFreeNeighborGridSquare(int gridSquare)
{
...
**/
bool GlobalPlanner::isStartAndGoalValid(int startGridSquare, int goalGridSquare)
{
  bool isvalid = true;
...
**/
float GlobalPlanner::getMoveCost(int gridSquareIndex1, int gridSquareIndex2)
{
...
**/
float GlobalPlanner::calculateHScore(int gridSquareIndex, int goalGridSquare)
{
...
**/
int GlobalPlanner::calculateGridSquareIndex(int i, int j) 
{
  return (i * width) + j;
}
...
**/
int GlobalPlanner::getGridSquareRowIndex(int index) //get the row index from gridSquare index
{
  return index / width;
}
...
**/
int GlobalPlanner::getGridSquareColIndex(int index) //get column index from gridSquare index
{
  return index % width;
}
...
**/
bool GlobalPlanner::isFree(int i, int j)
{
...
**/
bool GlobalPlanner::isFree(int gridSquareIndex)
{
  return occupancyGridMap[gridSquareIndex];
}
};
